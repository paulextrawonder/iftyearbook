              ...
              if(in_array($fileExtension, $isAllowed)){
                if ($error === 0) {
                    if ($size<500 * 1024) {
                        ...
                        $fileDestination = "yearbook/".$newFileName;
  ...
  <center>
    <div class="form__group">
      ...
      <button name="yearbook" class="btn__submit" style="font-size: 1.6rem; font-weight: 700">
        <a style="color:#fff; text-decoration: none;" href="index?action=yearbook">Year Book</a></button>
      <button name="throwback" class="btn__submit" style="font-size: 1.6rem; font-weight: 700">
        <a style="color:#fff; text-decoration: none;" href="index?action=throwback">Thowback</a></button>
    </div>
  </center>
